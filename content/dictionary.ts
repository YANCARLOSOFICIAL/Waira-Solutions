...
export const dictionary = {
  es: {
    ...
    cases: {
      ...
      subtitle: 'Una muestra real de nuestro trabajo, con el código disponible en GitHub.',
      items: [
        {
          tag: 'Automatización · Finanzas',
          title: 'Extracción de datos de facturas con IA',
          text: 'API que lee facturas en PDF y devuelve sus datos estructurados (proveedor, ítems, impuestos, totales) en JSON, lista para integrarse a cualquier sistema contable.',
        ...
        },
        {
          ...
          text: 'Genera exámenes, resúmenes, rúbricas y juegos educativos para docentes, con soporte de varios proveedores de IA y un sistema de créditos por institución.',
          tech: ['Next.js', 'FastAPI', 'PostgreSQL', 'OpenAI'],
          repo: 'YANCARLOSOFICIAL/plataforma-educativa-con-IA',
        },
        {
          tag: 'Atención al usuario',
          title: 'Guaca — asistente institucional con IA',
          text: 'Chatbot con RAG para una institución universitaria: responde sobre programas, sedes y admisiones a partir de los documentos oficiales, por texto y por voz.',
  ...
  en: {
    ...
    cases: {
      ...
      subtitle: 'A real sample of our work, with the code available on GitHub.',
      items: [
        {
          tag: 'Automation · Finance',
          title: 'AI invoice data extraction',
          text: 'An API that reads PDF invoices and returns structured data (supplier, line items, taxes, totals) as JSON, ready to plug into any accounting system.',
          tech: ['FastAPI', 'GPT-4o', 'Python', 'Docker'],
          repo: 'YANCARLOSOFICIAL/api-facturas-2',
        },
        {
          ...
          text: 'Generates exams, summaries, rubrics and educational games for teachers, with support for several AI providers and a per-institution credit system.',
          tech: ['Next.js', 'FastAPI', 'PostgreSQL', 'OpenAI'],
          repo: 'YANCARLOSOFICIAL/plataforma-educativa-con-IA',
        },
        {
          tag: 'User support',
          title: 'Guaca — AI institutional assistant',
          text: 'A RAG-powered chatbot for a university: answers questions about programs, campuses and admissions from official documents, by text and by voice.',
          tech: ['Next.js', 'FastAPI', 'pgvector', 'Redis'],
          repo: 'YANCARLOSOFICIAL/chatbot-uniputumayo',
        },
      ],
