  ...
  return (
    <main className="pt-28 pb-24 sm:pt-32">
      <Container className="max-w-3xl">
        ...
        <p className="mt-3 text-sm text-muted-foreground">Última actualización: Julio 2026</p>

        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:text-lg [&_h2]:font-medium [&_h2]:tracking-tight [&_h2]:text-foreground [&_p]:mb-4 [&_strong]:text-foreground">
          <section>
